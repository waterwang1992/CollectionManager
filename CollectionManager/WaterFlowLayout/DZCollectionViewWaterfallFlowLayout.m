//
//  DZCollectionViewWaterfallFlowLayout.m
...
@interface DZCollectionViewWaterfallFlowLayout ()
...
@implementation DZCollectionViewWaterfallFlowLayout

- (void)prepareLayout {
    [super prepareLayout];
    
    NSAssert(self.dataSource != nil, @"DZCollectionViewWaterfallFlowLayout.dataSource cann't be nil.");
...
//    }
    ...
    for (NSInteger section=0; section < numberOfSections; section++) {
        ...
        NSInteger const numberOfItems = [collectionView numberOfItemsInSection:section] > (NSIntegerMax-1) ? 0:[collectionView numberOfItemsInSection:section];
        ...
        if ([self.dataSource respondsToSelector:@selector(collectionView:layout:referenceHeightForFooterInSection:)]) {
            footerHeight = [self.dataSource collectionView:collectionView layout:self referenceHeightForFooterInSection:section];
...
- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect {
    ...
    if (_sectionHeadersPinToVisibleBounds) {
        [self.headerLayoutAttributes enumerateObjectsUsingBlock:^(UICollectionViewLayoutAttributes * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
